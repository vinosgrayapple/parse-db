#!/bin/bash
#2015##### awk -F"\";\"" '$1~/[ІI][МM]/ && $16~/(^2204.*|2206003900|2206005900)/{gsub(/\s+/," ",$0);gsub(/\x22;\x22/,"_____",$0);gsub(/\x22/,"",$0);gsub(/_____/,"\x22;\x22",$0);gsub(/(^|$)/,"\"",$0);gsub(/ \x22/,"\x22",$0);print}' 2015_Import-Export*.csv > 2015_2.txt
#2016##### awk -F"\";\"" '$2~/[ІI][МM]/ && $18~/(^2204.*|2206003900|2206005900)/{gsub(/\s+/," ",$0);gsub(/\x22;\x22/,"_____",$0);gsub(/\x22/,"",$0);gsub(/_____/,"\x22;\x22",$0);gsub(/(^|$)/,"\"",$0);gsub(/ \x22/,"\x22",$0);print}' ../2016\ import-export/2016_Import_Export\ *.csv > 2016_2.txt
#2017##### awk -F"\";\"" '$2~/[ІI][МM]/ && $16~/(^2204.*|2206003900|2206005900)/{gsub(/\x3Bnull/,"",$0);gsub(/\s+/," ",$0);gsub(/\x22;\x22/,"_____",$0);gsub(/\x22/,"",$0);gsub(/_____/,"\x22;\x22",$0);gsub(/(^|$)/,"\"",$0);gsub(/ \x22/,"\x22",$0);print}' ../2017\ import/2017_Import\ *.csv > 2017_2.txt
