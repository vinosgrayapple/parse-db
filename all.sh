#!/bin/bash
#2015##### awk -F"\";\"" '$1!~/ЕК/ && $16~/(^2204.*|^220600)/{gsub(/\s+/," ",$0);gsub(/\x22;\x22/,"_____",$0);gsub(/\x22/,"",$0);gsub(/_____/,"\x22;\x22",$0);gsub(/(^|$)/,"\"",$0);gsub(/ \x22/,"\x22",$0);print}' 2015_Import-Export*.csv > 2015_2.txt
